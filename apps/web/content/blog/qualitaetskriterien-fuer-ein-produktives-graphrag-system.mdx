...
excerpt: "Produktiv wird GraphRAG erst, wenn klare Qualitäts-Gates Begriffe, Beziehungen, Belegpfade, Kontextsteuerung und Runtime-Stabilität absichern."
...
diagramImages:
  - "/images/blog/graphrag-quality-diagram.png"
linkedinHook: "Ein GraphRAG-System ist nicht produktiv, weil es einen Graphen hat, sondern weil es unter realen Bedingungen reproduzierbare Entscheidungsqualität liefert."
...
- schwer wartbaren Retrieval-Setups
...
Ein produktives System muss Retrieval und Kontextumfang aktiv steuern.

Prüfkriterien:

- Gibt es definierte Regeln für Kontextauswahl?
- Sind Retrieval-Hops begrenzt oder bewusst gesteuert?
...
- Statusanzeigen für Retrieval und Synthese
...
3. **Regression-Gate** bei Änderungen an Retrieval- oder Rankinglogik
...
Retrieval- und Antwortprobleme werden nur an Einzelfällen diskutiert, ohne systematisches Logging und Metrikbezug.
...
Wie Prompt-Transparenz diese Qualitätsdisziplin fuer Stakeholder sichtbar und diskutierbar macht, ist Gegenstand des nächsten Essays.
