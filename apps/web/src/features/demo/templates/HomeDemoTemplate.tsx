...
export async function HomeDemoTemplate(): Promise<React.JSX.Element> {
  ...
  const copy =
    locale === "en"
      ? {
          eyebrow: "Live Demo",
          title: "Ask a question directly and inspect the reasoning live.",
          intro:
            "This page is the operational demo. The interactive GraphRAG workflow starts right below this intro.",
        }
      : {
          eyebrow: "Live Demo",
          title: "Stelle direkt eine Frage und prüfe die Herleitung live.",
          intro:
        ...
        <section className="border-b border-slate-200/70 bg-[radial-gradient(circle_at_top_left,rgba(14,165,233,0.1),transparent_38%),linear-gradient(180deg,rgba(255,255,255,0.96),rgba(248,250,252,0.92))]">
          <div className="mx-auto w-full max-w-295 px-4 py-8 sm:px-6 sm:py-10">
            <div className="space-y-4">
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-sky-600">{copy.eyebrow}</p>
