...
const NODES: RawSeedNode[] = [
  {
    ...
    shortDescription: "Autorin von Thinking in Systems und zentrale Referenz fuer Systemdynamik.",
    longDescription: "Autorin von Thinking in Systems und zentrale Referenz fuer Systemdynamik.",
    sourceType: PRIMARY_MD,
    sourceFile: "Thinking in Systems/Lesenotizen - Think in Systems.md",
  },
  {
    ...
    shortDescription: "Systemtheoretiker mit Fokus auf Gesamtleistung statt Teiloptimierung.",
    longDescription: "Systemtheoretiker mit Fokus auf Gesamtleistung statt Teiloptimierung.",
    sourceType: PRIMARY_MD,
    sourceFile: "Systems Thinking Speech by Dr. Russell Ackoff.md",
  },
  {
    ...
    shortDescription: "Systemarchitektin mit Fokus auf nicht-lineares Denken in Softwaresystemen.",
    longDescription: "Systemarchitektin mit Fokus auf nicht-lineares Denken in Softwaresystemen.",
    sourceType: PRIMARY_MD,
    sourceFile: "Learning Systems Thinking with Diana Montalion and Lisa Moritz.md",
  },
  {
    ...
    shortDescription: "Mitwirkende Stimme im Lernkontext zu System Thinking in der Softwarepraxis.",
    longDescription: "Mitwirkende Stimme im Lernkontext zu System Thinking in der Softwarepraxis.",
    sourceType: PRIMARY_MD,
    sourceFile: "Learning Systems Thinking with Diana Montalion and Lisa Moritz.md",
  },
  {
    ...
    shortDescription: "Kybernetiker und Urheber des Viable System Model.",
    longDescription: "Kybernetiker und Urheber des Viable System Model.",
    sourceType: PRIMARY_MD,
    sourceFile: "Konzepte/Viable System Model (VSM).md",
  },
  {
    ...
    shortDescription: "Grundlagenwerk zu Rueckkopplung, Dynamik und Systemgrenzen.",
    longDescription: "Grundlagenwerk zu Rueckkopplung, Dynamik und Systemgrenzen.",
    sourceType: PRIMARY_MD,
    sourceFile: "Thinking in Systems/Lesenotizen - Think in Systems.md",
  },
  {
    ...
    shortDescription: "Praxisorientierter Leitfaden fuer Systemdenken in modernen Informationssystemen.",
    longDescription: "Praxisorientierter Leitfaden fuer Systemdenken in modernen Informationssystemen.",
    sourceType: PRIMARY_MD,
    sourceFile: "Books/Book Learning Systems Thinking.md",
  },
  {
    ...
    shortDescription: "Klassische theoretische Grundlage fuer interdisziplinaeres Systemverstaendnis.",
    longDescription: "Klassische theoretische Grundlage fuer interdisziplinaeres Systemverstaendnis.",
    sourceType: PRIMARY_MD,
    sourceFile: "Books/General System Theory.md",
  },
  {
    ...
    shortDescription: "Werkzeugsammlung fuer Diagnose, Visualisierung und Intervention in komplexen Systemen.",
    longDescription: "Werkzeugsammlung fuer Diagnose, Visualisierung und Intervention in komplexen Systemen.",
    sourceType: PRIMARY_MD,
    sourceFile: "Books/System Thinking Tools.md",
  },
  {
    ...
    shortDescription: "Rueckkopplungsschleifen erklaeren dynamische Verstaerkung und Stabilisierung.",
    longDescription: "Rueckkopplungsschleifen erklaeren dynamische Verstaerkung und Stabilisierung.",
  ...
  },
  {
    ...
    shortDescription: "Systemelemente sind wechselseitig abhaengig und wirken nicht isoliert.",
    longDescription: "Systemelemente sind wechselseitig abhaengig und wirken nicht isoliert.",
  ...
  },
  {
    ...
    shortDescription: "Abgrenzung des betrachteten Systems steuert Fokus und Entscheidungsspielraum.",
    longDescription: "Abgrenzung des betrachteten Systems steuert Fokus und Entscheidungsspielraum.",
  ...
  },
  {
    ...
    shortDescription: "Ganzheitliche Sicht verhindert lokale Optimierung auf Kosten des Gesamtsystems.",
    longDescription: "Ganzheitliche Sicht verhindert lokale Optimierung auf Kosten des Gesamtsystems.",
  ...
  },
  {
    ...
    shortDescription: "Systematische Analyse von Annahmen und Argumenten fuer belastbare Schlussfolgerungen.",
    longDescription: "Systematische Analyse von Annahmen und Argumenten fuer belastbare Schlussfolgerungen.",
  ...
  },
  {
    ...
    shortDescription: "Systemeigenschaften entstehen aus Interaktionen und sind nicht auf Teile reduzierbar.",
    longDescription: "Systemeigenschaften entstehen aus Interaktionen und sind nicht auf Teile reduzierbar.",
  ...
  },
  {
    ...
    shortDescription: "Modell fuer anpassungsfaehige, langfristig lebensfaehige Organisationen.",
    longDescription: "Modell fuer anpassungsfaehige, langfristig lebensfaehige Organisationen.",
  ...
  },
  {
    ...
    shortDescription: "Pragmatische Entscheidungsregeln fuer Unsicherheit bei begrenzter Information.",
    longDescription: "Pragmatische Entscheidungsregeln fuer Unsicherheit bei begrenzter Information.",
  ...
  },
  {
    ...
    shortDescription: "Visualisierung von Ursache-Wirkungs-Beziehungen und Rueckkopplungen im System.",
    longDescription: "Visualisierung von Ursache-Wirkungs-Beziehungen und Rueckkopplungen im System.",
  ...
  },
  {
    ...
    shortDescription: "Unterscheidung zwischen sichtbaren Ereignissen und tieferen Strukturursachen.",
    longDescription: "Unterscheidung zwischen sichtbaren Ereignissen und tieferen Strukturursachen.",
  ...
  },
  {
    ...
    shortDescription: "Nicht-lineare Zusammenhaenge helfen bei Architekturentscheidungen unter Dynamik.",
    longDescription: "Nicht-lineare Zusammenhaenge helfen bei Architekturentscheidungen unter Dynamik.",
  ...
  },
  {
    ...
    shortDescription: "Komplexitaet ist angemessen zu behandeln statt durch lineare Modelle zu vereinfachen.",
    longDescription: "Komplexitaet ist angemessen zu behandeln statt durch lineare Modelle zu vereinfachen.",
  ...
  },
  {
    ...
    shortDescription: "Bestaende und Fluesse erklaeren zeitverzoegertes Verhalten in dynamischen Systemen.",
    longDescription: "Bestaende und Fluesse erklaeren zeitverzoegertes Verhalten in dynamischen Systemen.",
  ...
  },
  {
    ...
    shortDescription: "Ausgleichende Rueckkopplung stabilisiert Systeme um einen Zielzustand.",
    longDescription: "Ausgleichende Rueckkopplung stabilisiert Systeme um einen Zielzustand.",
  ...
  },
  {
    ...
    shortDescription: "Verstaerkende Rueckkopplung erzeugt Wachstum oder Eskalation in Systemen.",
    longDescription: "Verstaerkende Rueckkopplung erzeugt Wachstum oder Eskalation in Systemen.",
  ...
  },
  {
    ...
    shortDescription: "Resilienz beschreibt die Faehigkeit eines Systems, Stoerungen zu absorbieren.",
    longDescription: "Resilienz beschreibt die Faehigkeit eines Systems, Stoerungen zu absorbieren.",
  ...
  },
  {
    ...
    shortDescription: "Selbstorganisation erlaubt Systemen, neue Strukturen ohne zentrale Steuerung zu bilden.",
    longDescription: "Selbstorganisation erlaubt Systemen, neue Strukturen ohne zentrale Steuerung zu bilden.",
  ...
  },
  {
    ...
    shortDescription: "Wiederkehrende Dynamiken wie Tragedy of the Commons oder Escalation verschlechtern Systeme.",
    longDescription: "Wiederkehrende Dynamiken wie Tragedy of the Commons oder Escalation verschlechtern Systeme.",
  ...
  },
  {
    ...
    shortDescription: "Hebelpunkte sind Eingriffspunkte mit ueberproportionaler Systemwirkung.",
    longDescription: "Hebelpunkte sind Eingriffspunkte mit ueberproportionaler Systemwirkung.",
  ...
  },
  {
    ...
    shortDescription: "Policy Resistance entsteht, wenn Teilsysteme Interventionen gegeneinander ausgleichen.",
    longDescription: "Policy Resistance entsteht, wenn Teilsysteme Interventionen gegeneinander ausgleichen.",
  ...
  },
  {
    ...
    shortDescription: "Pattern Thinking identifiziert wiederkehrende Strukturmuster hinter beobachteten Ereignissen.",
    longDescription: "Pattern Thinking identifiziert wiederkehrende Strukturmuster hinter beobachteten Ereignissen.",
  ...
  },
  {
    ...
    shortDescription: "Systems Leadership gestaltet Kommunikations- und Entscheidungsstrukturen fuer komplexe Umfelder.",
    longDescription: "Systems Leadership gestaltet Kommunikations- und Entscheidungsstrukturen fuer komplexe Umfelder.",
  ...
  },
  {
    ...
    shortDescription: "Gemeinsame Ressourcen werden uebernutzt, wenn Kosten externalisiert bleiben.",
    longDescription: "Gemeinsame Ressourcen werden uebernutzt, wenn Kosten externalisiert bleiben.",
  ...
  },
  {
    ...
    shortDescription: "Gegenseitige Ueberbietung fuehrt zu selbstverstaerkender Konfliktdynamik.",
    longDescription: "Gegenseitige Ueberbietung fuehrt zu selbstverstaerkender Konfliktdynamik.",
  ...
  },
  {
    ...
    shortDescription: "Sinkende Standards normalisieren niedrige Leistung im Zeitverlauf.",
    longDescription: "Sinkende Standards normalisieren niedrige Leistung im Zeitverlauf.",
  ...
  },
  {
    ...
    shortDescription: "Ressourcen konzentrieren sich rekursiv bei bereits erfolgreichen Akteuren.",
    longDescription: "Ressourcen konzentrieren sich rekursiv bei bereits erfolgreichen Akteuren.",
  ...
  },
  {
    ...
    shortDescription: "Symptomloesungen verdraengen strukturelle Ursachenarbeit und erzeugen Abhaengigkeit.",
    longDescription: "Symptomloesungen verdraengen strukturelle Ursachenarbeit und erzeugen Abhaengigkeit.",
  ...
  },
  {
    ...
    shortDescription: "Akteure optimieren auf Regelindikatoren statt auf den eigentlichen Systemzweck.",
    longDescription: "Akteure optimieren auf Regelindikatoren statt auf den eigentlichen Systemzweck.",
  ...
  },
  {
    ...
    shortDescription: "Falsch gesetzte Ziele lenken das System in unerwuenschte Richtung.",
    longDescription: "Falsch gesetzte Ziele lenken das System in unerwuenschte Richtung.",
  ...
  },
  {
    ...
    shortDescription: "Parameteraenderungen sind wirksam, aber meist schwache Eingriffe.",
    longDescription: "Parameteraenderungen sind wirksam, aber meist schwache Eingriffe.",
  ...
  },
  {
    ...
    shortDescription: "Sichtbarkeit von Information aendert Entscheidungen und Systemverhalten direkt.",
    longDescription: "Sichtbarkeit von Information aendert Entscheidungen und Systemverhalten direkt.",
  ...
  },
  {
    ...
    shortDescription: "Regeln und Anreize steuern Handlungsraum und Kopplungen im System.",
    longDescription: "Regeln und Anreize steuern Handlungsraum und Kopplungen im System.",
  ...
  },
  {
    ...
    shortDescription: "Systemziele bestimmen priorisierte Dynamiken und Nebenwirkungen.",
    longDescription: "Systemziele bestimmen priorisierte Dynamiken und Nebenwirkungen.",
  ...
  },
  {
    ...
    shortDescription: "Paradigmenwechsel aendert grundlegende Systemlogik und Interventionseffekt.",
    longDescription: "Paradigmenwechsel aendert grundlegende Systemlogik und Interventionseffekt.",
  ...
  },
  {
    ...
    shortDescription: "Öffentliche Community-Ressourcen unterstützen kontinuierliches Lernen im Systemdenken.",
    longDescription: "Öffentliche Community-Ressourcen unterstützen kontinuierliches Lernen im Systemdenken.",
  ...
  },
  {
    ...
    shortDescription: "Systemdenken erweitert sich auf ko-adaptive Mensch-KI-Systeme mit rekursiven Lern- und Steuerungsdynamiken.",
    longDescription: "Systemdenken erweitert sich auf ko-adaptive Mensch-KI-Systeme mit rekursiven Lern- und Steuerungsdynamiken.",
  ...
  },
  {
    ...
    shortDescription: "CAST betrachtet Systeme mit nichtlinearen Interaktionen, Adaptivitaet und emergentem Verhalten.",
    longDescription: "CAST betrachtet Systeme mit nichtlinearen Interaktionen, Adaptivitaet und emergentem Verhalten.",
  ...
  },
  {
    ...
    shortDescription: "Second-Order Thinking bewertet direkte und indirekte Langzeitfolgen von Entscheidungen.",
    longDescription: "Second-Order Thinking bewertet direkte und indirekte Langzeitfolgen von Entscheidungen.",
  ...
  },
  {
    ...
    shortDescription: "Taxonomie und Ontologie ordnen Begriffe, Relationen und Klassen fuer konsistente Wissensmodelle.",
    longDescription: "Taxonomie und Ontologie ordnen Begriffe, Relationen und Klassen fuer konsistente Wissensmodelle.",
  ...
  },
  {
    ...
    shortDescription: "CATWOE strukturiert Perspektiven auf Problemkontexte ueber Kunden, Akteure und Transformation.",
    longDescription: "CATWOE strukturiert Perspektiven auf Problemkontexte ueber Kunden, Akteure und Transformation.",
  ...
  },
  {
    ...
    shortDescription: "Netzwerkanalyse identifiziert zentrale Knoten, Cluster und Flussmuster in komplexen Systemen.",
    longDescription: "Netzwerkanalyse identifiziert zentrale Knoten, Cluster und Flussmuster in komplexen Systemen.",
  ...
  },
  {
    ...
    shortDescription: "Mentale Modelle sind übertragbare Denkwerkzeuge zur strukturierten Bewertung komplexer Situationen.",
    longDescription: "Mentale Modelle sind übertragbare Denkwerkzeuge zur strukturierten Bewertung komplexer Situationen.",
  ...
  },
  {
    ...
    shortDescription: "Das 80/20-Prinzip fokussiert auf wenige Ursachen mit grossem Ergebniseffekt.",
    longDescription: "Das 80/20-Prinzip fokussiert auf wenige Ursachen mit grossem Ergebniseffekt.",
  ...
  },
  {
    ...
    shortDescription: "Beobachtung, Hypothese, Experiment und Replikation verbessern Entscheidungsqualitaet und Lernzyklen.",
    longDescription: "Beobachtung, Hypothese, Experiment und Replikation verbessern Entscheidungsqualitaet und Lernzyklen.",
  ...
  },
  {
    ...
    shortDescription: "Aufgeschobene Belohnung staerkt langfristige Zielverfolgung und robuste Entscheidungen.",
    longDescription: "Aufgeschobene Belohnung staerkt langfristige Zielverfolgung und robuste Entscheidungen.",
  ...
  },
  {
    ...
    shortDescription: "Systemarchetypen beschreiben wiederkehrende Strukturmuster mit typischen Dynamiken und Fehlentwicklungen.",
    longDescription: "Systemarchetypen beschreiben wiederkehrende Strukturmuster mit typischen Dynamiken und Fehlentwicklungen.",
  ...
  },
  {
    ...
    shortDescription: "Frühes Wachstum trifft auf begrenzende Faktoren und kippt ohne Gegenmassnahmen in Stagnation.",
    longDescription: "Frühes Wachstum trifft auf begrenzende Faktoren und kippt ohne Gegenmassnahmen in Stagnation.",
  ...
  },
  {
    ...
    shortDescription: "Kurzfristige Loesungen lindern Symptome, erzeugen aber langfristig neue oder staerkere Probleme.",
    longDescription: "Kurzfristige Loesungen lindern Symptome, erzeugen aber langfristig neue oder staerkere Probleme.",
  ...
  },
  {
    ...
    shortDescription: "System Mapping visualisiert Akteure, Grenzen, Beziehungen und Fluesse auf Systemebene.",
    longDescription: "System Mapping visualisiert Akteure, Grenzen, Beziehungen und Fluesse auf Systemebene.",
  ...
  },
  {
    ...
    shortDescription: "Rich Pictures machen Problemkontext, Perspektiven und Spannungen visuell sichtbar.",
    longDescription: "Rich Pictures machen Problemkontext, Perspektiven und Spannungen visuell sichtbar.",
  ...
  },
  {
    ...
    shortDescription: "Stock-and-Flow-Diagramme modellieren Bestaende, Zu- und Abfluesse dynamischer Systeme.",
    longDescription: "Stock-and-Flow-Diagramme modellieren Bestaende, Zu- und Abfluesse dynamischer Systeme.",
  ...
  },
  {
    ...
    shortDescription: "Zeitverlaufsgrafiken zeigen Muster, Trends und Verzogerungen in Systemverhalten.",
    longDescription: "Zeitverlaufsgrafiken zeigen Muster, Trends und Verzogerungen in Systemverhalten.",
  ...
  },
  {
    ...
    shortDescription: "System-Archetypen helfen wiederkehrende Problemstrukturen und Hebel zu erkennen.",
    longDescription: "System-Archetypen helfen wiederkehrende Problemstrukturen und Hebel zu erkennen.",
  ...
  },
  {
    ...
    shortDescription: "Systemigramme bilden narrative Kausalketten und Wechselwirkungen in komplexen Lagen ab.",
    longDescription: "Systemigramme bilden narrative Kausalketten und Wechselwirkungen in komplexen Lagen ab.",
  ...
  },
  {
    ...
    shortDescription: "Stakeholder-Maps strukturieren Einfluss, Interessen und Konfliktlinien im System.",
    longDescription: "Stakeholder-Maps strukturieren Einfluss, Interessen und Konfliktlinien im System.",
  ...
  },
  {
    ...
    shortDescription: "Szenarioplanung erkundet robuste Entscheidungen fuer mehrere Zukunftspfade.",
    longDescription: "Szenarioplanung erkundet robuste Entscheidungen fuer mehrere Zukunftspfade.",
  ...
  },
  {
    ...
    shortDescription: "Modellierungssoftware unterstuetzt Simulation, Sensitivitaetsanalyse und Teamkommunikation.",
    longDescription: "Modellierungssoftware unterstuetzt Simulation, Sensitivitaetsanalyse und Teamkommunikation.",
  ...
  },
  {
    ...
    shortDescription: "CLA verbindet Ereignisse, systemische Ursachen, Weltbilder und Narrativebenen.",
    longDescription: "CLA verbindet Ereignisse, systemische Ursachen, Weltbilder und Narrativebenen.",
  ...
  },
  {
    ...
    shortDescription: "Das Iceberg Model verbindet Ereignisse mit Mustern, Strukturen und mentalen Modellen.",
    longDescription: "Das Iceberg Model verbindet Ereignisse mit Mustern, Strukturen und mentalen Modellen.",
  ...
  },
  {
    ...
    shortDescription: "CLDs zeigen verstaerkende und ausgleichende Rueckkopplungsschleifen im System.",
    longDescription: "CLDs zeigen verstaerkende und ausgleichende Rueckkopplungsschleifen im System.",
  ...
  },
  {
    ...
    shortDescription: "Das VSM strukturiert Steuerung, Koordination und Anpassungsfaehigkeit komplexer Organisationen.",
    longDescription: "Das VSM strukturiert Steuerung, Koordination und Anpassungsfaehigkeit komplexer Organisationen.",
  ...
  },
  {
    ...
    shortDescription: "Ein Heuristik-Katalog hilft bei schnellen Entscheidungen unter Unsicherheit und Zeitdruck.",
    longDescription: "Ein Heuristik-Katalog hilft bei schnellen Entscheidungen unter Unsicherheit und Zeitdruck.",
  ...
  },
  {
    ...
    shortDescription: "Die Emergenz-Linse fokussiert auf neue Eigenschaften, die aus Interaktionen vieler Teile entstehen.",
    longDescription: "Die Emergenz-Linse fokussiert auf neue Eigenschaften, die aus Interaktionen vieler Teile entstehen.",
  ...
  },
  {
    ...
    shortDescription: "Boundary Analysis macht sichtbar, was innerhalb und ausserhalb der Systembetrachtung liegt.",
    longDescription: "Boundary Analysis macht sichtbar, was innerhalb und ausserhalb der Systembetrachtung liegt.",
  ...
  },
  {
    ...
    shortDescription: "SSM verbindet Rich Pictures, Root Definitions und iterative Verbesserungen in weichen Problemlagen.",
    longDescription: "SSM verbindet Rich Pictures, Root Definitions und iterative Verbesserungen in weichen Problemlagen.",
  ...
  },
  {
    ...
    shortDescription: "Netzwerkvisualisierung macht Knoten-Kanten-Strukturen, Cluster und Zentralitaet sichtbar.",
    longDescription: "Netzwerkvisualisierung macht Knoten-Kanten-Strukturen, Cluster und Zentralitaet sichtbar.",
  ...
  },
  {
    ...
    shortDescription: "Szenarioanalyse beschreibt alternative Zukunftsbilder fuer robuste Entscheidungen unter Unsicherheit.",
    longDescription: "Szenarioanalyse beschreibt alternative Zukunftsbilder fuer robuste Entscheidungen unter Unsicherheit.",
  ...
  },
  {
    ...
    shortDescription: "Optimierung einzelner Teile verschlechtert in komplexen Systemen die Gesamtleistung.",
    longDescription: "Optimierung einzelner Teile verschlechtert in komplexen Systemen die Gesamtleistung.",
  ...
  },
  {
    ...
    shortDescription: "Lineares Denken unterschlaegt Rueckkopplungen und Nebenwirkungen in Systemen.",
    longDescription: "Lineares Denken unterschlaegt Rueckkopplungen und Nebenwirkungen in Systemen.",
  ...
  },
  {
    ...
    shortDescription: "Reine Ereignisreaktion ohne Strukturursachen fuhrt zu wiederkehrenden Problemen.",
    longDescription: "Reine Ereignisreaktion ohne Strukturursachen fuhrt zu wiederkehrenden Problemen.",
  ...
  },
  {
    ...
    shortDescription: "Heuristische Verzerrungen erschweren robuste Entscheidungen in dynamischen Umfeldern.",
    longDescription: "Heuristische Verzerrungen erschweren robuste Entscheidungen in dynamischen Umfeldern.",
  ...
  },
  {
    ...
    shortDescription: "Organisationen verlieren Anpassungsfaehigkeit ohne balancierte Koordinationsebenen.",
    longDescription: "Organisationen verlieren Anpassungsfaehigkeit ohne balancierte Koordinationsebenen.",
  ...
  },
  {
    ...
    shortDescription: "Kurzfristige Loesungen verschieben die Last und verstaerken spaeter das urspruengliche Problem.",
    longDescription: "Kurzfristige Loesungen verschieben die Last und verstaerken spaeter das urspruengliche Problem.",
  ...
  },
  {
    ...
    shortDescription: "Symptomatische Eingriffe verdrängen nachhaltige Ursachenarbeit und erhoehen langfristige Abhaengigkeit.",
    longDescription: "Symptomatische Eingriffe verdrängen nachhaltige Ursachenarbeit und erhoehen langfristige Abhaengigkeit.",
  ...
  },
  {
    ...
    shortDescription: "Verstaerkendes Wachstum trifft auf spaet wirksame Begrenzungen und kippt in Stagnation.",
    longDescription: "Verstaerkendes Wachstum trifft auf spaet wirksame Begrenzungen und kippt in Stagnation.",
  ...
  },
  {
    ...
    shortDescription: "Ressourcenallokation bevorzugt bestehende Gewinner und vergroessert strukturelle Ungleichgewichte.",
    longDescription: "Ressourcenallokation bevorzugt bestehende Gewinner und vergroessert strukturelle Ungleichgewichte.",
  ...
  },
  {
    ...
    shortDescription: "Individuelle Optimierung uebernutzt gemeinsame Ressourcen und untergraebt kollektive Stabilitaet.",
    longDescription: "Individuelle Optimierung uebernutzt gemeinsame Ressourcen und untergraebt kollektive Stabilitaet.",
  ...
  },
  {
    ...
    shortDescription: "Reaktive Gegenmassnahmen zwischen Akteuren treiben gegenseitige Aufruestungsschleifen.",
    longDescription: "Reaktive Gegenmassnahmen zwischen Akteuren treiben gegenseitige Aufruestungsschleifen.",
  ...
  },
  {
    ...
    shortDescription: "Wiederholte Zielabsenkung kaschiert Leistungsdefizite und normalisiert sinkende Standards.",
    longDescription: "Wiederholte Zielabsenkung kaschiert Leistungsdefizite und normalisiert sinkende Standards.",
  ...
  },
  {
    ...
    shortDescription: "Nachfragewachstum ohne Kapazitaetsinvestition erzeugt Engpaesse und selbstverstaerkende Verschlechterung.",
    longDescription: "Nachfragewachstum ohne Kapazitaetsinvestition erzeugt Engpaesse und selbstverstaerkende Verschlechterung.",
  ...
  },
  {
    ...
    shortDescription: "Gut gemeinte lokale Anpassungen fuehren zu unbeabsichtigten Zielkonflikten zwischen Partnern.",
    longDescription: "Gut gemeinte lokale Anpassungen fuehren zu unbeabsichtigten Zielkonflikten zwischen Partnern.",
  ...
  },
  {
    ...
    shortDescription: "Ressourcen fließen kurzfristig in attraktive Felder und entziehen strukturell wichtige Grundlagenarbeit.",
    longDescription: "Ressourcen fließen kurzfristig in attraktive Felder und entziehen strukturell wichtige Grundlagenarbeit.",
  ...
  },
  {
    ...
    shortDescription: "System Mapping macht Akteure, Wechselwirkungen und Randbedingungen als Entscheidungsgrundlage sichtbar.",
    longDescription: "System Mapping macht Akteure, Wechselwirkungen und Randbedingungen als Entscheidungsgrundlage sichtbar.",
  ...
  },
  {
    ...
    shortDescription: "Boundary Critique hinterfragt bewusst, welche Perspektiven im Modell eingeschlossen oder ausgeschlossen sind.",
    longDescription: "Boundary Critique hinterfragt bewusst, welche Perspektiven im Modell eingeschlossen oder ausgeschlossen sind.",
  ...
  },
  {
    ...
    shortDescription: "Bewusstsein fuer Zeitverzoegerungen verhindert Fehldeutung kurzfristiger Signale als stabile Trends.",
    longDescription: "Bewusstsein fuer Zeitverzoegerungen verhindert Fehldeutung kurzfristiger Signale als stabile Trends.",
  ...
  },
  {
    ...
    shortDescription: "Interventionen scheitern, wenn Gegenreaktionen im Gesamtsystem staerker wirken als die beabsichtigte Steuerung.",
    longDescription: "Interventionen scheitern, wenn Gegenreaktionen im Gesamtsystem staerker wirken als die beabsichtigte Steuerung.",
  ...
  },
  {
    ...
    shortDescription: "Adaptive Capacity beschreibt die systemische Faehigkeit, auf Stoerungen lernend und robust zu reagieren.",
    longDescription: "Adaptive Capacity beschreibt die systemische Faehigkeit, auf Stoerungen lernend und robust zu reagieren.",
  ...
  },
  {
    ...
    shortDescription: "Mehrschleifiges Lernen verbindet Ergebnisfeedback mit Reflexion ueber Regeln und Zielsetzungen.",
    longDescription: "Mehrschleifiges Lernen verbindet Ergebnisfeedback mit Reflexion ueber Regeln und Zielsetzungen.",
  ...
  },
  {
    ...
    shortDescription: "Wirksame Eingriffe haengen von zeitlicher Platzierung entlang Rueckkopplungsstrukturen ab.",
    longDescription: "Wirksame Eingriffe haengen von zeitlicher Platzierung entlang Rueckkopplungsstrukturen ab.",
  ...
  },
  {
    ...
    shortDescription: "Entscheidungen auf Mikroebene koennen meso- und makroskopische Dynamiken unvorhergesehen verstaerken.",
    longDescription: "Entscheidungen auf Mikroebene koennen meso- und makroskopische Dynamiken unvorhergesehen verstaerken.",
  ...
  },
  {
    ...
    shortDescription: "Kleine lokale Anpassungen koennen schleichend in eine strategisch unguenstige Systemarchitektur fuehren.",
    longDescription: "Kleine lokale Anpassungen koennen schleichend in eine strategisch unguenstige Systemarchitektur fuehren.",
  ...
  },
  {
    ...
    shortDescription: "Steigende Kopplung und Abstimmungskosten koennen den Nutzen neuer Interventionspfade neutralisieren.",
    longDescription: "Steigende Kopplung und Abstimmungskosten koennen den Nutzen neuer Interventionspfade neutralisieren.",
...
function normalizeLongDescription(node: RawSeedNode): string {
  if (typeof node.longDescription === "string" && node.longDescription.trim().length > 0) {
    return node.longDescription.trim();
  }
  return node.summary.trim();
}
...
export function createSeedDataset(): SeedDataset {
  ...
  return {
    ...
    nodes: NODES.map((node) => ({
      ...node,
      shortDescription: normalizeShortDescription(node),
      longDescription: normalizeLongDescription(node),
      internalSource: {
