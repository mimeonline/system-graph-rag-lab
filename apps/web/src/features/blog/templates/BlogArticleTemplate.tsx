        ...
        <div className="mx-auto grid w-full max-w-[1180px] gap-4 lg:grid-cols-[minmax(0,1fr)_280px]">
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2 text-sm text-slate-500">
              <time dateTime={frontmatter.publishedAt}>{new Date(frontmatter.publishedAt).toLocaleDateString("de-DE")}</time>
              <span>·</span>
            ...
            {frontmatter.linkedinHook ? (
              <section className="mt-4 rounded-xl border border-violet-200 bg-violet-50 p-3">
                <p className="text-xs font-semibold uppercase tracking-[0.12em] text-violet-800">LinkedIn Hook</p>
