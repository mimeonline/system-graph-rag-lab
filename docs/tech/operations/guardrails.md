...
1. Das Query-Panel sendet ausschließlich `POST /api/query` mit dem `query`-Payload.
2. Loading-, Error- und Empty-Zustände deaktivieren den Submit-Button bei laufender Anfrage, wodurch das Rate-Limit durch UI-Steuerung zusätzlich geschützt wird.
