...
1. Geprueft wurde der Story-Gate-Stand fuer `E1-S1`, `E1-S2` und `E1-S3` im Modus `RUN_MODE=review`.
2. Geprueft wurden Story-Akzeptanzkriterien, Dev-Handoff-Commands und QA-Artefakte.
3. Nicht im Scope dieses Runs waren die Story-Gates fuer `E1-S4`, `E1-S5` und `E1-S6`.
...
3. Story-Reihenfolge hat einen offenen Prozesskonflikt, da `E1-S3` von `E1-S5` abhaengt, `E1-S5` aber noch `todo` ist.

## Referenzen auf Bugs und Reports
1. Story-Gate Ergebnis `E1-S3` siehe `docs/qa/verdict.md`.
