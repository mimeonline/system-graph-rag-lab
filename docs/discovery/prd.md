...
4. Nachvollziehbare Herleitung in der Antwortdarstellung auf MVP-Niveau.
...
2. Antworten können bei einzelnen Fragen zu wenig belastbare Referenzkonzepte zeigen.
3. Öffentliche Nutzung kann Betriebskosten erhöhen, falls Guardrails nicht sauber greifen.
4. Unterschiedliche Erwartungen an Qualitätsmessung können die Abnahme verzögern.

## Annahmen
1. Der bestehende Domänenrahmen reicht aus, um mindestens fünf Demo-Fragen belastbar zu beantworten.
2. Die Zielgruppe akzeptiert den experimentellen Charakter, wenn Struktur und Herleitung klar sind.
...
2. Mindestens 90 Prozent erfolgreicher Antworten enthalten mindestens drei relevante Referenzkonzepte, sofern verfügbar.
3. Nutzer finden Query-Eingabe, Antwortbereich und Referenzkonzepte ohne zusätzliche Erklärung.
4. Demo ist öffentlich erreichbar und operativ stabil.
5. Keine Secrets im Repository und keine ungeplanten API-Ausgaben über dem gesetzten Limit.
...
3. Referenzkonzepte werden in Antworten konsistent sichtbar gemacht.
4. Guardrails für Key-Limit, Rate-Limit und Secret-Hygiene sind aktiv und überprüfbar.
5. PM-Artefakte sind auf denselben Scope konsolidiert.
